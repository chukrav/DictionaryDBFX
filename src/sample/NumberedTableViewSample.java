...
public class NumberedTableViewSample extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        numberCol.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Person,Person>,
                ObservableValue<Person>>() {
            @Override
            public ObservableValue<Person> call(TableColumn.CellDataFeatures<Person,Person> p) {
